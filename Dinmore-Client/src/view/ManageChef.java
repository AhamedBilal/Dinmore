 ...
 * @author Bilal
 */
public class ManageChef extends javax.swing.JPanel {

    /**
     * Creates new form ManageChef
     */
    public ManageChef() {
        initComponents();
        loadAll();
    ...
    private void loadAll() {
        ...
        dtm.setRowCount(0);
        try {
            List<ChefDTO> re = AdminController.getAllChefs();
            if (re == null) {
                return;
            }
    ...
    private void initComponents() {
        ...
        txt_cid.setForeground(new java.awt.Color(179, 57, 57));
        txt_cid.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(179, 57, 57)));
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        txt_cid.setText(tbl.getValueAt(r, 0).toString());
        txt_pass.setText(tbl.getValueAt(r, 1).toString());
    }//GEN-LAST:event_tblMouseClicked

    private void btn_regActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_regActionPerformed
        try {
            boolean b = AdminController.addChef(new ChefDTO(txt_cid.getText(), txt_pass.getText()));
    ...
    private void btn_removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_removeActionPerformed
        try {
            boolean b = AdminController.fireChef(txt_cid.getText());
            JOptionPane.showMessageDialog(this, b ? "Removed" : "Faild");
            loadAll();
            clearAll();
        } catch (Exception ex) {
            Logger.getLogger(ManageRec.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        try {
            boolean b = AdminController.updateChef(new ChefDTO(txt_cid.getText(), txt_pass.getText()));
